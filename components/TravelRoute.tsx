        ...
        {ferryRoutes.map((ferry) => (
          ...
          >
            <div className="flex justify-between items-start">
              <div>
                <h4 className="font-medium text-gray-800">{ferry.operator}</h4>
              ...
              <div className="mt-1 grid grid-cols-3 gap-2">
                {Object.entries(ferry.price).map(([type, price]) => (
                  ...
                  >
                    ...
                    <div className="text-rose-500 font-semibold">${price}</div>
                  </div>
                ))}
              </div>
            </div>
    ...
    >
      ...
      <div className="mt-8 pt-6 border-t border-gray-100">
        <div className="flex justify-between items-center">
          ...
          <span className="text-2xl font-bold text-rose-500">${totalCost}</span>
        </div>
